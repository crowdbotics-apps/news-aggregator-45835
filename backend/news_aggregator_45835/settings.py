"""
Django settings for news_aggregator_45835 project.
...
ROOT_URLCONF = 'news_aggregator_45835.urls'
...
WSGI_APPLICATION = 'news_aggregator_45835.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "news_aggregator_45835 API",
    "DESCRIPTION": "API documentation for news_aggregator_45835 App",
    "VERSION": "v1",
}
